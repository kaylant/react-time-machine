...
function app() {
    ...
    var AppView = _react2.default.createClass({
        ...
        _timeMarchesOn: function _timeMarchesOn() {
            if (!this.state.incrementing) {
                ...
                var boundFunction = incrementYear.bind(this);
                this.interval = setInterval(boundFunction, 500);
            } else {
        ...
        _timeMarchesBack: function _timeMarchesBack() {
            if (!this.state.incrementing) {
                ...
                var boundFunction = decrementYear.bind(this);
                this.interval = setInterval(boundFunction, 500);
            } else {
                clearInterval(this.interval);
                this.setState({
        ...
        _timeFreeze: function _timeFreeze() {
            return {
                incrementing: false
            };
        },
        ...
        render: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    "button",
                    { className: "timeButton", onClick: this._timeMarchesOn },
                    this.state.forward
                ),
                _react2.default.createElement(
                    "button",
                    { className: "timeButton", onClick: this._timeMarchesBack },
                    this.state.backward
                )
            );
        }
